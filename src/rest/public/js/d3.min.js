...
!function (t, n) {
    ...
    function sn() {
        function t() {
            ...
            if (c || (c = t = Tt()), l < f && (s = l, l = f, f = s), l > mv)if (d > wv - mv)c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > mv && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v)); else {
                ...
                if (S > mv) {
                    ...
                    if (d < xv) {
                        var F = w > mv ? an(z, P, D, O, R, U, q, L) : [q, L], I = z - F[0], Y = P - F[1], B = R - F[0], j = U - F[1], H = 1 / Math.sin(Math.acos((I * B + Y * j) / (Math.sqrt(I * I + Y * Y) * Math.sqrt(B * B + j * j))) / 2), X = Math.sqrt(F[0] * F[0] + F[1] * F[1]);
        ...
        function n(t) {
            function n(t) {
                ...
                if ("c" === p)m = _(t) + m, t = ""; else {
                    ...
                    if (g = (x ? "(" === a ? a : "-" : "-" === a || "(" === a ? "" : a) + g, m = m + ("s" === p ? Pg[8 + Ng / 3] : "") + (x && "(" === a ? ")" : ""), y)for (n = -1, i = t.length; ++n < i;)if (c = t.charCodeAt(n), 48 > c || c > 57) {
    ...
    function Vo(t, n, r, i, o, u, a, c, s) {
        ...
        var h = ko(mo, rr), d = h.invert, v = h.domain, _ = s(".%L"), y = s(":%S"), g = s("%I:%M"), m = s("%I %p"), x = s("%a %d"), b = s("%b %d"), w = s("%B"), M = s("%Y"), T = [[a, 1, Vg], [a, 5, 5 * Vg], [a, 15, 15 * Vg], [a, 30, 30 * Vg], [u, 1, Wg], [u, 5, 5 * Wg], [u, 15, 15 * Wg], [u, 30, 30 * Wg], [o, 1, $g], [o, 3, 3 * $g], [o, 6, 6 * $g], [o, 12, 12 * $g], [i, 1, Zg], [i, 2, 2 * Zg], [r, 1, Gg], [n, 1, Jg], [n, 3, 3 * Jg], [t, 1, Qg]];
    ...
    function Yc(t, n) {
        ...
        if (i) {
            n = null == n ? null : n + "";
            for (r in i)if ((e = i[r]).state > km && e.name === n)return new Uc([[t]], Lm, n, +r)
        }
        return null
    }
    ...
    function Wc(t, n) {
        function e(e) {
            var s, f = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i, l = null == o ? n.tickFormat ? n.tickFormat.apply(n, r) : Bc : o, h = Math.max(u, 0) + c, p = t === Um || t === Om ? jc : Hc, d = n.range(), v = d[0] + .5, _ = d[d.length - 1] + .5, y = (n.bandwidth ? Xc : Bc)(n.copy()), g = e.selection ? e.selection() : e, m = g.selectAll(".domain").data([null]), x = g.selectAll(".tick").data(f, n).order(), b = x.exit(), w = x.enter().append("g").attr("class", "tick"), M = x.select("line"), T = x.select("text"), k = t === Um || t === Fm ? -1 : 1, S = t === Fm || t === Dm ? (s = "x", "y") : (s = "y", "x");
    ...
    function ff() {
        ...
        var e = Xm, r = !1, i = 1, o = 1, u = [0], a = Fs, c = Fs, s = Fs, f = Fs, l = Fs;
        return t.round = function (n) {
    ...
    function fl(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = Gm._; a;)if (r = ll(a, u) - o, r > ex)a = a.L; else {
            if (i = o - hl(a, u), !(i > ex)) {
    ...
    function vl(t, n) {
        ...
        for (Km = [], Jm = new Array(t.length), Gm = new If, Qm = new If; ;)if (i = Zm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x))o[0] === e && o[1] === r || (fl(o), e = o[0], r = o[1]), o = t.pop(); else {
            if (!i)break;
            sl(i.arc)
        }
        if (nl(), n) {
    ...
    function xh(t, n) {
        var e = ph([t * sb, n * sb]);
        if (Ux) {
            var r = vh(Ux, e), i = [r[1], -r[0], 0], o = vh(i, r);
            gh(o), o = hh(o);
    ...
    function Eh(t) {
        ...
        return Dx = Ox = null, Ex === 1 / 0 || Cx === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Ex, Cx], [zx, Px]]
    }
    ...
    function ip(t, n, e, r) {
        ...
        return function (u) {
            ...
            function d(o, u) {
                var a = i(o, u);
                if (_ && y.push([o, u]), k)g = o, m = u, x = a, k = !1, a && (N.lineStart(), N.point(o, u)); else if (a && T)N.point(o, u); else {
                    var c = [b = Math.max(Bb, Math.min(Yb, b)), M = Math.max(Bb, Math.min(Yb, M))], s = [o = Math.max(Bb, Math.min(Yb, o)), u = Math.max(Bb, Math.min(Yb, u))];
    ...
    function Rp(t, n) {
        var e = n[0], r = n[1], i = [gb(e), -pb(e), 0], o = 0, u = 0;
        lw.reset();
    ...
    P.prototype = q.prototype = {
        constructor: P, has: function (t) {
            ...
            var t = [];
            for (var n in this)n[0] === Od && t.push({key: n.slice(1), value: this[n]});
            return t
        }, size: function () {
            var t = 0;
    ...
    F.prototype = I.prototype = {
        constructor: F, has: Fd.has, add: function (t) {
            return t += "", this[Od + t] = t, this
        }, remove: Fd.remove, clear: Fd.clear, values: Fd.keys, size: Fd.size, empty: Fd.empty, each: Fd.each
    };
    ...
    Mt.prototype = Tt.prototype = {
        constructor: Mt, moveTo: function (t, n) {
            ...
            if (null === this._x1)this._.push("M", this._x1 = t, ",", this._y1 = n); else if (l > dv)if (Math.abs(f * a - c * s) > dv && i) {
        ...
        constructor: Tr, on: function (t, n) {
            var e, r = this._, i = kr(t + "", r), o = -1, u = i.length;
            {
                if (!(arguments.length < 2)) {
                    ...
                    for (; ++o < u;)if (e = (t = i[o]).type)r[e] = Nr(r[e], t.name, n); else if (null == n)for (e in r)r[e] = Nr(r[e], t.name, null);
                    return this
                }
    ...
    var My = new Date, Ty = new Date, ky = Zr(function () {
    }, function (t, n) {
        t.setTime(+t + n)
    }, function (t, n) {
        return n - t
    ...
    var qg, Lg = {"-": "", _: " ", 0: "0"}, Rg = /^\s*\d+/, Ug = /^%/, Dg = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;
    so({
        dateTime: "%x, %X",
        date: "%-m/%-d/%Y",
        time: "%-I:%M:%S %p",
    ...
    if (t.event = null, "undefined" != typeof document) {
        ...
        "onmouseenter" in mm || (gm = {mouseenter: "mouseover", mouseleave: "mouseout"})
    }
    Tu.prototype = {
    ...
    var Lm = [null], Rm = Array.prototype.slice, Um = 1, Dm = 2, Om = 3, Fm = 4, Im = 1e-6;
    ...
    var ox = {name: "drag"}, ux = {name: "space"}, ax = {name: "handle"}, cx = {name: "center"}, sx = {
        name: "x",
        handles: ["e", "w"].map(zl),
        input: function (t, n) {
        ...
        se: "nwse-resize",
        sw: "nesw-resize"
    }, px = {e: "w", w: "e", nw: "ne", ne: "nw", se: "sw", sw: "se"}, dx = {
        n: "s",
        s: "n",
        nw: "sw",
        ne: "se",
        se: "ne",
        sw: "nw"
    }, vx = {overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1}, _x = {
        overlay: 1,
        selection: 1,
        n: -1,
        e: null,
    ...
    var Cb, zb, Pb, qb, Lb, Rb, Ub, Db, Ob, Fb, Ib, Yb = 1e9, Bb = -Yb, jb = Gl(), Hb = {
        ...
        polygonStart: eh,
        polygonEnd: eh
    }, Xb = [null, null], Vb = {type: "LineString", coordinates: Xb}, Wb = Gl(), $b = Gl(), Zb = {
        point: eh,
        lineStart: eh,
        lineEnd: eh,
        polygonStart: function () {
