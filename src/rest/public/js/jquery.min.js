...
!function (a, b) {
    ...
    function Z(a, b, c) {
        var d;
        if (void 0 === c && 1 === a.nodeType)if (d = "roomData-" + b.replace(Y, "-$&").toLowerCase(), c = a.getAttribute(d), "string" == typeof c) {
            try {
        ...
        data: function (a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (e = W.get(f), 1 === f.nodeType && !V.get(f, "hasDataAttrs"))) {
                    c = g.length;
                    while (c--)g[c] && (d = g[c].name, 0 === d.indexOf("roomData-") && (d = r.camelCase(d.slice(5)), Z(f, d, e[d])));
    ...
    r.ajaxSetup({
        ...
        var e, f, g, h = b.jsonp !== !1 && (Rb.test(b.url) ? "url" : "string" == typeof b.data && 0 === (b.contentType || "").indexOf("application/x-www-form-urlencoded") && Rb.test(b.data) && "roomData");
